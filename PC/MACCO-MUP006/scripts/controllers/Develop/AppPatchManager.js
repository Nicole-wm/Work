maccoApp.factory('macco', function ($http) {
    ...
    var url = window.$AppApiService + 'AdminApi/Patch/FetchPatchList';
...
maccoApp.controller('ProjectController', function ($scope,macco,$http,$window,$rootScope) {
    ...
    $scope.AddNew = function () {
        var url = '/DeveToolManagement/AppPatchDetails.html?Token=' + $rootScope.Token + '&Type=Create';
        $window.location.href = url;
    };

    $scope.Update = function (ID) {
        var url = '/DeveToolManagement/AppPatchDetails.html?Token=' + $rootScope.Token + '&Type=Update&ID=' + ID;
        $window.location.href = url;
    };

    $scope.Visit = function (ID) {
        var url = '/DeveToolManagement/AppPatchDetails.html?Token=' + $rootScope.Token + '&Type=Visit&ID=' + ID;
        $window.location.href = url;
    };
