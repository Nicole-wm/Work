...
var url = window.$AppApiService + 'AdminApi/Showindex/FetchShowIndexComment';
...
maccoApp.controller('CommentListController', function($scope, $http,Upload,macco,$window,$rootScope,$modal) {
    ...
    $scope.AddNew = function() {
        var modalInstance = $modal.open({
            animation: true,
            templateUrl: '/ShowManagement/CommentDetails.html',
    ...
    $scope.Delete = function(ShowCommentID) {
        if ($rootScope.Operating) {
            var production_deleteUrl = window.$AppApiService + 'AdminApi/Showindex/DeleteShowIndexComment';
            var param = {
