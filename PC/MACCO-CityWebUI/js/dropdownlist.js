     ...
     */
     ...
     DDLClass.prototype = {
         ...
         _createFromSelect : function() {
            ...
            input.parent().click(function(event){
                if($(this).attr('data-showwing') == 1){
                    self.hide();
                    $(".dropdown-select").attr('data-showwing',0);
                    $(".dropdown-list").hide();
                }else{
                    $(".dropdown-select").attr('data-showwing',0);
                    $(".dropdown-list").hide();
        ...
        show : function(){
            ...
            var positionTop;
            if(this.configs.attrs.column>=5){
                positionTop=position.top - 4.4*parent[0].offsetHeight;
            }else{
                positionTop=position.top + parent[0].offsetHeight;
            }
            var tmpStyles = {
                'position': 'absolute',
                'margin-bottom': '20px',
                ...
                'z-index': (parseInt(self.select.parent().css('z-index'),300) || 0) + 300
            };
