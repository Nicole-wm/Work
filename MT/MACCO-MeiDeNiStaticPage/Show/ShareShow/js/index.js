    ...
    macco.prototype.nextPage = function () {
        ...
        $http.post(url, param).success(function (data) {
            ...
            if (items != undefined) {
                ...
                if (items.length > 0) {
                    this.after = items[data.Data.length - 1].ID;
                } else {
                    this.after = 0;
                }
            }
...
app.controller('shareController', ['$sce', '$scope', '$http', 'macco', '$window', '$location', '$rootScope', '$interval', '$timeout', function ($sce, $scope, $http, macco, $window, $location, $rootScope, $interval, $timeout) {
    ...
    function AppendTag(LineNum, SytleNum, TagArr, TagNum, textNum) {
        ...
        if (LineNum == 1) {
            if (SytleNum == 1) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_text noteFLeft noteTextTop2" tagNum="' + TagNum[0] + '"  textNum="' + textNum[0] + '">' + TagArr[0] + '</div></div>';
            } else if (SytleNum == 2) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate note_dot_right"></div><div class="note_dot_around note_dot_around_right"></div><div class="note_text noteFLeft noteTextTop2" tagNum="' + TagNum[0] + '"  textNum="' + textNum[0] + '">' + TagArr[0] + '</div></div>';
            } else if (SytleNum == 3) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_line note_line3"></div><div class="note_text noteFLeft noteTextLeft" tagNum="' + TagNum[0] + '"  textNum="' + textNum[0] + '">' + TagArr[0] + '</div></div>';
            } else if (SytleNum == 4) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate  note_dot_2right"></div><div class="note_dot_around  note_dot_around_2right"></div><div class="note_line note_line5 noteRight3"></div><div class="note_text noteFLeft  tagNum="' + TagNum[0] + '""  textNum="' + textNum[0] + '">' + TagArr[0] + '</div></div>';
            } else {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_text noteFLeft noteTextTop2"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div></div>';
            }
        } else if (LineNum == 2) {
            if (SytleNum == 1) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_line note_line1"></div><div class="note_line note_line2"></div><div class="note_text noteFLeft noteTextTop4"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFLeft" tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div></div>';
            } else if (SytleNum == 2) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate noteRight9"></div><div class="note_dot_around noteRight5"></div><div class="note_line note_line1 noteRight"></div><div class="note_line note_line2 noteRight"></div><div class="note_text noteFRight noteTextTop4"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFRight"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div></div>';
            } else if (SytleNum == 3) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_line note_line3"></div><div class="note_line note_line4"></div><div class="note_text noteFLeft noteTextTop4 noteTextLeft"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFLeft noteTextLeft"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div></div>';
            } else if (SytleNum == 4) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate note_dot_2right"></div><div class="note_dot_around  note_dot_around_2right"></div><div class="note_line note_line5 noteRight3"></div><div class="note_line note_line6 noteRight3"></div><div class="note_text noteFRight noteTextTop4"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFRight"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div></div>';
            } else {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_line note_line1"></div><div class="note_line note_line2"></div><div class="note_text noteFLeft noteTextTop4"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFLeft"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div></div>';
            }
        } else if (LineNum == 3) {
            if (SytleNum == 1) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate"></div><div class="note_dot_around"></div><div class="note_line note_line1 noteLineHeight noteLineTop"></div><div class="note_line note_line2 noteLineHeight"></div><div class="note_text noteFLeft noteTextTop5"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFLeft noteTextTop2"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div><div class="note_text noteFLeft noteTextTop"  tagNum="' + TagNum[2] + '" textNum="' + textNum[2] + '">' + TagArr[2] + '</div></div>';
            } else if (SytleNum == 2) {
                TagHtml = '<div class="NoteContent"><div class="note_dot note_dot_bg note_dot_bg_animate noteRight9"></div><div class="note_dot_around noteRight5"></div><div class="note_line note_line1 noteLineHeight noteLineTop noteRight"></div><div class="note_line note_line2 noteLineHeight noteRight"></div><div class="note_text noteFRight noteTextTop5"  tagNum="' + TagNum[0] + '" textNum="' + textNum[0] + '">' + TagArr[0] + '</div><div class="note_text noteFRight noteTextTop2"  tagNum="' + TagNum[1] + '" textNum="' + textNum[1] + '">' + TagArr[1] + '</div><div class="note_text noteFRight noteTextTop"  tagNum="' + TagNum[2] + '" textNum="' + textNum[2] + '">' + TagArr[2] + '</div></div>';
            } else if (SytleNum == 3) {
    ...
    FetchCommentDetailUrl = function () {
    ...
    $scope.allTitleClick = function () {
        ...
        if (platform == 'iOS') {
            if (window.webkit) {
                ...
                window.webkit.messageHandlers.ShowAllComment.postMessage(obj);
            } else {
                window.location.href = "macco://EndLoading/";
            }
        } else if (platform == 'Android') {
    ...
    $scope.goDetail = function(ID) {
        ...
        if (platform == 'iOS') {
            if (window.webkit) {
                window.webkit.messageHandlers.GoNext.postMessage(ID);
            } else {
                window.location.href = "macco://EndLoading/";
            }
        } else if (platform == 'Android') {
...
var ShowChildAtIndexClass = function() {

};

ShowChildAtIndexClass.prototype.idx = 0;
ShowChildAtIndexClass.prototype.showChildAtIndex = function(children,index) {
    var self = this;
     $(children[self.idx]).show(200,function(){
        self.idx++;
        console.log(self.idx);
        if(self.idx <= children.length -1) {
            self.showChildAtIndex(children);
        } else {
            var $parent = $(children[self.idx-1]).parent();
            var $noteDot = $parent.find('.note_dot');
            $noteDot.addClass('note_dot_bg_animate');
        }
    });
}
...
$(document).ready(function () {
    ...
    hammer.on("tap",function() {
        ...
        if(isHiden) {
            $('.NoteContent').hide();
            $('.NoteContent > div').hide();
            $('.note_dot').removeClass('note_dot_bg_animate');
        } else {
            $('.NoteContent').show();
            
            $('.NodeDiv').each(function(idx,ele){
               var child = $(ele).find('.NoteContent > div'); 
               var showChildAtIndexObj = new ShowChildAtIndexClass();
               showChildAtIndexObj.showChildAtIndex(child);
            });
