...
phonecatApp.controller('newactivityController',['$scope' ,'$http','macco','$location','$rootScope',function ($scope, $http,macco, $location, $rootScope) {
    ...
    if (share == 'no') {
       $scope.shareline1 = "参与方法：分享本活动至微信朋友圈 微博有机会送";
    } else {
        $scope.shareline1 = "参与方法：点击马上参与，就能获得更多免费礼品哦！";
    }
    ...
    var joinFn = function () {
     ...
     $http.post(url, param).success(function (data) {
        ...
        if (data.IsSuccess) {
            ...
            console.log("WinUsers",$scope.WinUsers);
            //活动时间
            /*
