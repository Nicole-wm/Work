...
phonecatApp.controller('CommentCtrl',['$scope','$http','macco','$location','$rootScope','$interval',function ($scope,$http,macco,$location, $rootScope,$interval) {
